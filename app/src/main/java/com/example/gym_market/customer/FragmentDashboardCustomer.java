...
public class FragmentDashboardCustomer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerViewDashboardAdapter = new AdapterDashboardCustomer(getActivity(), modelDashboard);
        ...
        viewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), AllDataStoreCustomer.class));
