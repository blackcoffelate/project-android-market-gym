...
public class FragmentProfileCustomer extends Fragment {
    ...
    ModelUser modelUser;
    private TextView fullnameCustomer, addressCustomer;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_profile_customer, container, false);
        ...
        fullnameCustomer = v.findViewById(R.id.fullname_customer);
        addressCustomer = v.findViewById(R.id.address_customer);
        fullnameCustomer.setText(modelUser.getFullname());
        addressCustomer.setText(modelUser.getAddress());
